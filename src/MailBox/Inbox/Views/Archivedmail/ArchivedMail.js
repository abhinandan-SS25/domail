...
const ArchivedMail = (props) => {
    ...
    const email_list = emails.map(email=>{
        return (
            <div onClick={()=>props.changeview(<Email raiseCompose={props.raiseCompose} email={email} changeview={props.changeview} back={<ArchivedMail raiseCompose={props.raiseCompose} changeview={props.changeview} user={props.user}/>} />)} style={{backgroundColor:email.read?"#dedede":"white", borderColor:"green"}} id={email.id} className="email_rep">
    ...
    return (
        <div className="mails" id="archivedmail">
